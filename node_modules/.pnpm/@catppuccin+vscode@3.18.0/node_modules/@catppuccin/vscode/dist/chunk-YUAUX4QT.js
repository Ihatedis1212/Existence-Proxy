// ../catppuccin-vsc/src/theme/index.ts
import { flavors as flavors2 } from "@catppuccin/palette";

// ../catppuccin-vsc/src/theme/tokens/cpp.ts
var tokens = (context) => {
...
// ../catppuccin-vsc/src/theme/tokens/cs.ts
var tokens2 = (context) => {
  const { palette } = context;
  return [
    {
...
// ../catppuccin-vsc/src/theme/tokens/css.ts
var tokens3 = (context) => {
  const { palette } = context;
  return [
    {
...
// ../catppuccin-vsc/src/theme/tokens/data.ts
var tokens4 = (context) => {
  const { palette } = context;
  return [
    {
...
// ../catppuccin-vsc/src/theme/tokens/diff.ts
var tokens5 = (context) => {
  const { palette } = context;
  return [
    {
...
// ../catppuccin-vsc/src/theme/tokens/dotenv.ts
var tokens6 = (context) => {
  const { palette } = context;
  return [
    {
...
// ../catppuccin-vsc/src/theme/tokens/gdscript.ts
var tokens7 = (context) => {
  const { palette } = context;
  return [
    {
...
// ../catppuccin-vsc/src/theme/tokens/golang.ts
var tokens8 = (context) => {
  const { palette } = context;
  return [
    {
...
// ../catppuccin-vsc/src/theme/tokens/graphql.ts
var tokens9 = (context) => {
  const { palette } = context;
  return [
    {
...
// ../catppuccin-vsc/src/theme/tokens/html.ts
...
// ../catppuccin-vsc/src/theme/tokens/java.ts
...
// ../catppuccin-vsc/src/theme/tokens/javascript.ts
...
// ../catppuccin-vsc/src/theme/tokens/julia.ts
...
// ../catppuccin-vsc/src/theme/tokens/latex.ts
...
// ../catppuccin-vsc/src/theme/tokens/liquid.ts
...
var liquid_default = tokens15;

// ../catppuccin-vsc/src/theme/tokens/lua.ts
...
var lua_default = tokens16;

// ../catppuccin-vsc/src/theme/tokens/markdown.ts
...
var markdown_default = tokens17;

// ../catppuccin-vsc/src/theme/tokens/nix.ts
...
var nix_default = tokens18;

// ../catppuccin-vsc/src/theme/tokens/php.ts
...
var php_default = tokens19;

// ../catppuccin-vsc/src/theme/tokens/python.ts
...
var python_default = tokens20;

// ../catppuccin-vsc/src/theme/tokens/r.ts
...
var r_default = tokens21;

// ../catppuccin-vsc/src/theme/tokens/regex.ts
var tokens22 = (context) => {
  const { palette } = context;
  return [
    {
...
var regex_default = tokens22;

// ../catppuccin-vsc/src/theme/tokens/rust.ts
var tokens23 = (context) => {
  const { palette } = context;
  return [
    {
      name: "Rust attribute",
...
var rust_default = tokens23;

// ../catppuccin-vsc/src/theme/tokens/shell.ts
var tokens24 = (context) => {
  const { palette } = context;
  return [
    {
      name: "Shell shebang",
...
var shell_default = tokens24;

// ../catppuccin-vsc/src/theme/tokens/typst.ts
var tokens25 = (context) => {
  const { palette } = context;
  return [
    {
...
var typst_default = tokens25;

// ../catppuccin-vsc/src/theme/tokens/index.ts
function tokens26(context) {
...
// ../catppuccin-vsc/src/theme/tokenColors.ts
var getTokenColors = (context) => {
  const { options } = context;
  return tokens26(context).map((token) => {
...
// ../catppuccin-vsc/src/theme/semanticTokens.ts
...
// ../catppuccin-vsc/src/theme/utilities.ts
var mix = (color1, color2, amount) => tinycolor.mix(color1, color2, amount * 100).toHexString();
var opacity = (color, opacity2) => tinycolor(color).setAlpha(opacity2).toHex8String();
var shade = (color, magnitude) => magnitude > 0 ? tinycolor(color).lighten(magnitude * 100).toHexString() : tinycolor(color).darken(Math.abs(magnitude * 100)).toHexString();
var transparent = "#00000000";

// ../catppuccin-vsc/src/theme/extensions/error-lens.ts
...
// ../catppuccin-vsc/src/theme/extensions/github-pull-request.ts
...
// ../catppuccin-vsc/src/theme/extensions/gitlens.ts
function colors3(context) {
...
// ../catppuccin-vsc/src/theme/extensions/index.ts
...
// ../catppuccin-vsc/src/theme/ui/azureDataStudio.ts
var azureDataStudio = (context) => {
  const { options, palette } = context;
...
var azureDataStudio_default = azureDataStudio;

// ../catppuccin-vsc/src/theme/ui/brackets.ts
...
// ../catppuccin-vsc/src/theme/ui/workbench.ts
...
// ../catppuccin-vsc/src/theme/ui/customNames.ts
import { flavors } from "@catppuccin/palette";
var ctpColors = new Set(Object.keys(flavors.mocha.colors));
var CustomUIColorError = class extends Error {
...
var hexColorRegex = /^#([\dA-Fa-f]{3,4}){1,2}$/;
...
var compileTheme = (flavor = "mocha", options = defaultOptions) => {
  var _a, _b;
  const flavorData = flavors2[flavor];
  const ctpPalette = {};
  const paletteAnsi = {
    normal: {},
    bright: {}
