import { AccentName, FlavorName, Colors } from '@catppuccin/palette';
...
type CatppuccinAccent = AccentName;
type CatppuccinFlavor = FlavorName;

type CatppuccinWorkbenchMode = "default" | "flat" | "minimal";
type CatppuccinBracketMode =
  | "rainbow"
  | "dimmed"
  | "monochromatic"
  | "neovim";

type CatppuccinPalette = Colors<string>;
...
type CustomUIColors = Partial<FlavorsPlusAll<Record<string, string>>>;
 ...
 * ```
 */
declare const compile: (flavor: FlavorName, overrides?: Partial<ThemeOptions>) => {
    name: string;
    type: string;
    colors: Partial<Record<keyof WorkbenchColors, string>>;
