...
declare const latte: {
    ...
    colors: {
        ...
        "table.headerBackground": string;
        "table.headerForeground": string;
        "list.focusAndSelectionBackground": string;
    };
...
export { frappe, latte, macchiato, mocha };
