 ...
 */
export declare function refreshMetadata(metadata: metadata, docRoot: string, stable?: string, dev?: string, packageFile?: string): metadata;
/**
 ...
 */
export declare function refreshMetadataVersions(versions: version[], docRoot: string, packageFile: string): (`v${string}` | undefined)[];
/**
 ...
 */
export declare function refreshMetadataAlias(alias: semanticAlias, versions: version[], stable?: 'auto' | version, dev?: 'auto' | version): version | undefined;
/**
 ...
 */
export declare function getLatestVersion(alias: semanticAlias, versions: version[], stable?: 'auto' | version, dev?: 'auto' | version): version | undefined;
/**
 ...
 * @param pegVersion
 */
export declare function makeAliasLink(alias: semanticAlias, docRoot: string, pegVersion: version, makeRelativeSymlinks?: boolean): void;
/**
 ...
 * @param dev
 */
export declare function makeMinorVersionLinks(versions: version[], docRoot: string, makeRelativeSymlinks?: boolean, stable?: 'auto' | version, dev?: 'auto' | version): void;
/**
 ...
 */
export declare function getSymlinkVersion(symlink: string, docRoot: string): version | undefined;
/**
