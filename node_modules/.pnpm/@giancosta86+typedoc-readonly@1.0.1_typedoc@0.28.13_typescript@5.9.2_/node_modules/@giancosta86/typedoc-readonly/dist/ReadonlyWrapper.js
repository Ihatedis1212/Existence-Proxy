export class ReadonlyWrapper {
    subject;
    static get(logger, referenceType) {
        const isLanguageProvidedReadonly = referenceType.name == "Readonly" && referenceType.package == "typescript";
        ...
        if (!referenceType.typeArguments[0]) {
            logger.warn(`Found a Readonly<> with unspecified type argument: ${referenceType}`);
            return null;
        }
